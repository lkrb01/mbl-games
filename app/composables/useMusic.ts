...
const TRACKS: Record<string, Track> = {
  ...
  // ── Scramble: tense E minor, 152 BPM ─────────────────────────────────────
  scramble: {
    bpm: 152, loop: 16,
    voices: [
      { type: 'sawtooth', vol: 0.09, notes: [
        [0,1,40],[1,1,40],[2,1,45],[3,1,43],[4,1,40],[5,1,40],[6,1,47],[7,1,45],
        [8,1,38],[9,1,38],[10,1,43],[11,1,41],[12,1,38],[13,1,40],[14,2,36],
      ]},
      { type: 'square', vol: 0.07, notes: [
        [0,2,64],[2,1,67],[3,1,66],[4,2,64],[6,1,62],[7,1,60],
        [8,2,59],[10,1,60],[11,1,62],[12,2,60],[14,1,59],[15,1,57],
      ]},
    ],
  },

  // ── Dig Dug: bouncy F major, 128 BPM ─────────────────────────────────────
  'dig-dug': {
    bpm: 128, loop: 16,
    voices: [
      { type: 'square', vol: 0.12, notes: [
        [0,1,41],[2,1,41],[4,1,48],[5,1,46],[6,1,44],[7,1,43],
        [8,1,43],[10,1,43],[12,1,50],[13,1,48],[14,1,46],[15,1,44],
      ]},
      { type: 'triangle', vol: 0.09, notes: [
        [0,1,65],[1,1,67],[2,2,69],[4,1,67],[5,1,65],[6,2,64],
        [8,1,62],[9,1,64],[10,2,65],[12,1,64],[13,1,62],[14,2,60],
      ]},
    ],
  },
